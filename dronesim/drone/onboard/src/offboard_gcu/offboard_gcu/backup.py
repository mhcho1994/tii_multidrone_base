...
class offboard_mission_module(rclpy.node.Node,flight_management):
    ...
    def __init__(self):
        ...
        self.vehicle_command_publisher_.insert(idx,self.create_publisher(VehicleCommand,f'/{fmu[0]}/fmu/in/vehicle_command',qos_profile_pub))
        self.trajectory_setpoint_publisher_         =   self.create_publisher(TrajectorySetpoint,f'/{fmu[0]}/fmu/in/trajectory_setpoint', qos_profile_pub)
        self.offboard_control_mode_publisher_       =   self.create_publisher(OffboardControlMode,f'/{fmu[0]}/fmu/in/offboard_control_mode',qos_profile_pub)
    ...
    def obfm_callback(self):
        ...
        if (self.total_callback_counter_ <= numpy.uint64(10/self.timer_period)):
            ...
            self.publish_vehicle_command(VehicleCommand.VEHICLE_CMD_COMPONENT_ARM_DISARM,param1=self.ARMING_ACTION_ARM_)
            self.publish_vehicle_command(VehicleCommand.VEHICLE_CMD_DO_SET_MODE,param1=1, \
            ...
            self.publish_vehicle_command(VehicleCommand.VEHICLE_CMD_DO_SET_MODE,param1=1,param2=self.PX4_CUSTOM_MAIN_MODE_OFFBOARD_)
    ...
    def publish_vehicle_command(self,command,param1=float(0.0),param2=float(0.0),param3=float(0.0)):
        ...
        msg.source_system                           =   2 # system sending the command
