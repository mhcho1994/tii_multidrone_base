...
if __name__ == '__main__': 
	...
	run_commands = [
		...
		'cd ~/px4; PX4_SYS_AUTOSTART=4001 PX4_GZ_MODEL_POSE=${PX4_GZ_MODEL_POSE_3} PX4_GZ_MODEL=${PX4_GZ_MODEL_3} ./build/px4_sitl_default/bin/px4 -i ${INSTANCE_SIGN_3}']	# Open Terminator shells and run the commands 
